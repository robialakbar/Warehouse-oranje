...
class ProductController extends Controller
{
    ...
    public function product_save(Request $req){
        ...
        [
            ...
            'purchase_price.required'    => 'Purchase Price harus berupa angka!',
            'sale_price.required'       => 'Sale Price belum diisi!',
            'sale_price.required'        => 'Sale Price harus berupa angka!',
    ...
    public function product_wip_save(Request $req){
        ...
        [
            ...
            'pamount.required'       => 'Amount harus berupa angka!',
        ]);
    ...
    public function product_wip_complete(Request $req){
        ...
        [
            ...
            'amount.required'    => 'Amount harus berupa angka!',
        ]);
